angular
  .module("stockManagementController", ["stockServices"])
  .controller(
    "stockManagement",
    function ($scope, $http, $location, $timeout, $compile, Stock) {
      $scope.StockItem = {};
      $scope.FetchefStock = [];
      ...
      $scope.AddStockItem = function () {
        ...
        Swal.fire({
          ...
          preConfirm: function () {
            ...
            if (
              $scope.getBase64.length > 0 &&
              typeof $scope.StockItem.name !== "undefined" &&
              typeof $scope.StockItem.model !== "undefined" &&
              typeof $scope.StockItem.price !== "undefined" &&
              typeof $scope.StockItem.category !== "undefined"
            ) {
              $scope.continue = true;
      ...
      $scope.EditStockItem = function (item) {
        ...
        Swal.fire({
          ...
          preConfirm: function () {
            ...
            if (
              $scope.getBase64.length > 0 &&
              typeof $scope.EditItem.name !== "undefined" &&
              typeof $scope.EditItem.model !== "undefined" &&
              typeof $scope.EditItem.price !== "undefined" &&
              typeof $scope.EditItem.category !== "undefined"
            ) {
              $scope.continue = true;
              return $scope.continue;
            } else {
